...
<div class="container">
  ...
  <div id="tab-knockout" class="tab-pane" style="display:none">
    ...
    <div id="knockoutContainer" class="knockout-container" style="overflow-x:hidden;overflow-y:auto;padding-bottom:14px;max-height:calc(100vh - 200px);"></div>
  </div>
  <!-- TAB 3: 赛程 -->
...
function renderKnockout() {
  ...
  // totalH 必须容纳 R32 全部 16 场 + F 列下面 3rd 的位置
  const totalH = padY + 16 * rowH + 50;
  let svg = `<svg width="${totalW}" height="${totalH}" viewBox="0 0 ${totalW} ${totalH}" preserveAspectRatio="xMidYMin meet" xmlns="http://www.w3.org/2000/svg" style="display:block;width:100%;height:auto;font-family:system-ui,'PingFang SC',sans-serif;">`;
