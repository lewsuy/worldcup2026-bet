...
// 渲染单张卡片（HTML div，非 SVG）
  function cardHtml(roundKey, m) {
    ...
    if (finished && koGames[m.no]) {
      ...
      scoreLine = `<div style="margin-top:8px;padding-top:6px;border-top:1px dashed ${borderColor};color:#ffd700;font-size:16px;font-weight:700;text-align:center;">${ha} - ${aa}</div>`;
    }
